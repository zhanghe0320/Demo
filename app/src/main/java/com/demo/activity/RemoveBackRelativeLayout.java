...
/**
 */
public class RemoveBackRelativeLayout extends RelativeLayout implements View.OnClickListener {
    // 默认定点圆半径
    public static final float DEFAULT_RADIUS = 1000;
...
//    TextView mNavigationFive;
    ...
    public RemoveBackRelativeLayout(Context context) {
        super(context);
    }

    public RemoveBackRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RemoveBackRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public RemoveBackRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
